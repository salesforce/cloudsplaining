...
class TemplateConfigTestCase(unittest.TestCase):
    ...
    def test_no_custom_files_returns_default(self):
        """When no custom files exist, should return default content"""
    ...
    def test_custom_files_with_content(self):
        """Custom files with content should be processed correctly"""
    ...
    def test_empty_custom_files_hide_navigation(self):
        """Empty custom files should hide navigation tabs"""
    ...
    def test_javascript_string_escaping(self):
        """HTML content should be properly escaped for JavaScript"""
    ...
    def test_mixed_scenario_one_custom_one_default(self):
        """Should handle mixed scenario with one custom file and one default"""
