...
class TemplateConfigTestCase(unittest.TestCase):
    ...
    def test_no_custom_files_returns_default(self):
        """test_template_config: When no custom files exist, should return default content"""
    ...
    def test_custom_files_with_content(self):
        """test_template_config: Custom files with content should be processed correctly"""
    ...
    def test_empty_custom_files_hide_navigation(self):
        """test_template_config: Empty custom files should hide navigation tabs"""
    ...
    def test_javascript_string_escaping(self):
        """test_template_config: HTML content should be properly escaped for JavaScript"""
