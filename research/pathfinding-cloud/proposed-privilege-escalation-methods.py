...
PRIVILEGE_ESCALATION_METHODS_PATHFINDING_ADDITIONS = {
    ...
    ],  # cloudformation-004 -- modifies existing stack set but passes a new role
    ...
    "PassExistingRoleToNewECSClusterServiceTask": [
        ...
        "ecs:createservice",
    ],  # ecs-001 -- VARIANT of ecs-003 (adds ecs:CreateCluster) -> overlaps ecs-003
    "PassExistingRoleToNewECSClusterRunTask": [
        "iam:passrole",
        "ecs:createcluster",
        "ecs:registertaskdefinition",
        "ecs:runtask",
    ],  # ecs-002 -- VARIANT of ecs-004 (adds ecs:CreateCluster) -> overlaps ecs-004
    ...
    "PassExistingRoleToNewECSTaskViaStartTask": [
        "iam:passrole",
        "ecs:registertaskdefinition",
        "ecs:starttask",
    ],  # ecs-005
    ...
    "PassExistingRoleToNewLambdaThenAddPermission": [
        "iam:passrole",
        "lambda:createfunction",
        "lambda:addpermission",
    ],  # lambda-006
    "PassExistingRoleToNewSageMakerNotebookInstance": [
        "iam:passrole",
    ...
    "AccessExistingBedrockCodeInterpreter": [
        "bedrock-agentcore:startcodeinterpretersession",
        "bedrock-agentcore:invokecodeinterpreter",
    ],  # bedrock-002
    ...
    ],  # iam-012 -- cloudsplaining UpdateRolePolicyToAssumeIt bundles sts:assumerole; standalone case
    "AttachRolePolicyThenUpdateAssume": [
        "iam:attachrolepolicy",
        "iam:updateassumerolepolicy",
    ],  # iam-019 -- VARIANT of iam-009; superset of AttachRolePolicyWithoutAssume
    "PutRolePolicyThenUpdateAssume": [
        "iam:putrolepolicy",
        "iam:updateassumerolepolicy",
    ],  # iam-021 -- VARIANT of iam-005; superset of PutRolePolicyWithoutAssume
    # --- self-escalation: modify own permissions directly ---
    "PutRolePolicyWithoutAssume": [
        "iam:putrolepolicy"
    ],  # iam-005 -- cloudsplaining PutRolePolicy bundles sts:assumerole; this is the standalone case
    "AttachRolePolicyWithoutAssume": [
        "iam:attachrolepolicy"
    ],  # iam-009 -- cloudsplaining AttachRolePolicy bundles sts:assumerole; this is the standalone case
}
